...
//alert settings
            if ($rowSettings->item == 'alert_missing_subject') {
                $aum_msg_missing_subject = $rowSettings->value;
            }
            
            if ($rowSettings->item == 'alert_missing_receiver') {
                $aum_msg_missing_receiver = $rowSettings->value;
            }              
            
            if ($rowSettings->item == 'alert_missing_message') {
                $aum_msg_missing_message = $rowSettings->value;
            }
            
//search setting

            if ($rowSettings->item == 'term_search_string') {
                $aum_term_search_string = $rowSettings->value;
            }
            
            if ($rowSettings->item == 'term_search_button') {
                $aum_term_search_button = $rowSettings->value;
            } 

            if ($rowSettings->item == 'btn_search') {
                $aum_btn_search = $rowSettings->value;
            }             
        }
    }
